...
class ApplicationDetails extends Component {
	...
	componentDidMount = async () => {
		...
		fetchPayment({
			constructionType:complaint.constructionType,
			durationInMonths: complaint.bkDuration,
			residentialCommercial:complaint.residentialCommercial,
			storage:complaint.areaRequired,
			villageCity:complaint.villageCity
		})
                ...
                /> */}
							...
							<div style={{
								...
								{(role === "ao" &&
									...
									(role === "employee" &&
										(
											(complaint.status != "PENDINGPAYMENT" && complaint.status != "REJECTED" &&
												// <ActionButton
